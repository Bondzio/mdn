...
set :repository,  "git@github.com:scervera/MDN-Website.git"
...
set :deploy_to, "/home/turn2god/mdn/"
set :user, "turn2god"
set :use_sudo, false
...
role :web, "turn2god.net"                          # Your HTTP server, Apache/etc
role :app, "turn2god.net"                          # This may be the same as your `Web` server
role :db,  "turn2god.net", :primary => true # This is where Rails migrations will run
