...
role :web, "mdn.thecerveras.com"                          # Your HTTP server, Apache/etc
role :app, "mdn.thecerveras.com"                          # This may be the same as your `Web` server
role :db,  "mdn.thecerveras.com", :primary => true # This is where Rails migrations will run
